...
const struct MysteryGiftDistributionData custom_mgdd_Ultima = {
	1, 0,
	{1008, WC_ICON_UNOWN_QM, VAR_RESULT, WC_TYPE_2, WC_COLOR_SILVER, WC_SHARE_YES, 7, _("Test 1"), _("Test 2WWWW"), {_("Test 3"), _("Test 4"), _("Test 5"), _("Test 6")}, _("Test 7"), _("Wins: {DYNAMIC}   / Losses: {DYNAMIC}À  / Trades: {DYNAMIC}Á  $")},
