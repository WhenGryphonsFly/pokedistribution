...
struct DodrioStruct
{
    ...
    u16 unk4A[5][6];
    u16 unk86[5];
    u8 ALIGNED(4) unk90[5];
    u8 ALIGNED(4) unk98[4];
    u8 ALIGNED(4) unk9C[11];
    u8 ALIGNED(4) unkA8[5];
    u8 ALIGNED(4) unkB0[5];
    u8 ALIGNED(4) unkB8[11];
    u8 ALIGNED(4) unkC4[11];
    u8 ALIGNED(4) unkD0[11];
    u8 ALIGNED(4) unkDC[11];
    u8 ALIGNED(4) unkE8[11];
    u8 ALIGNED(4) unkF4[11][2];
    u8 ALIGNED(4) unk10C[5];
    u16 unk112;
    u16 unk114;
    u32 unk118;
    u32 unk11C;
    ...
    u32 unk130[5];
    u8 ALIGNED(4) unk144;
    u8 ALIGNED(4) unk148[11];
    u8 ALIGNED(4) unk154;
    u8 ALIGNED(4) unk158[5];
